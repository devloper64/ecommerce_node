...
export default {
    ...
    async stripePaymentInstant(checkoutId, userObj) {
        ...
        if (!checkout) {
            ...
            let result = { httpStatus: httpStatus.NOT_ACCEPTABLE, status: "failed", errorDetails: "Either the requested checkout record does not exist or it does not belong to you" };
            return result;
        }
